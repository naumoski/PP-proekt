...
public class NaiveBayesSerial {
	...
	private static void bayesClassify(String att1, String att2, String att3,
	...
	public static void main(String[] args){
		...
		initiateVariables();
		readData();
		bayesClassify("Local-gov", "Doctorate", "Divorced", "Tech-support",
